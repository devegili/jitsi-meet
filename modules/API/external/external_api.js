...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Veksti Meet in it.
     *
     * @param {string} domain - The domain name of the server that hosts the
     * conference.
    ...
    /**
     * Getter for the large video element in Veksti Meet.
     *
    ...
    /**
     * Getter for participant specific video element in Veksti Meet.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Veksti Meet
    ...
    /**
     * Removes the listeners and removes the Veksti Meet frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Veksti Meet.
     *
