 ...
 * in external_connect.js for Veksti Meet. Parses the room name and JSON Web
 * Token (JWT) from the URL and executes createConnectionExternally.
 *
 * NOTE: If you are using lib-jitsi-meet without Veksti Meet, you should use this
 * file as reference only because the implementation is Veksti Meet-specific.
 *
