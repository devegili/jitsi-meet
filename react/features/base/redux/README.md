Veksti Meet - redux state persistence
====================================
Veksti Meet has a persistence layer that persists specific subtrees of the redux
...
When it's done, Veksti Meet will automatically persist these subtrees and
