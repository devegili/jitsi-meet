...
/**
 * Restores a Veksti Meet config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The Veksti Meet config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "Veksti Meet"
    // }
    // We want to have:
    // json = {
    //     config: {
