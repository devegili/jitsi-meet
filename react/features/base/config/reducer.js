 ...
 * JitsiMeetJS#init(). The app will download config.js from the Veksti Meet
 ...
 * The app will download config.js from the Veksti Meet deployment and take its
 ...
 * config.js from the Veksti Meet deployment and take its values into account but
...
function _setConfig(state, { config }) {
    ...
    const newState = _.merge(
        ...
        // downloaded from the Veksti Meet deployment because the former contains
